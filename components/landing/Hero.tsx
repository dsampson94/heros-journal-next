...
export function Hero() {
    return (
        <Container className="pb-16 pt-20 text-center lg:pt-32">
          ...
          <span className="relative">Journaling</span>
        </span>{' '}

            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
                Manage your voice notes, get personalised Ai insights and document your thoughts like a boss with Hero&apos;s Journal.
            </p>
